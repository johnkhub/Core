...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'Readers')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" =  'CD_PPP')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'CD_IAM')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'CD_GI')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'CD_EI')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'CD_HI')
);
...
SELECT access_control.sp_grant_access(
    ...
    (SELECT principal_id FROM access_control.principal WHERE "name" = 'CD_RNM')
);
