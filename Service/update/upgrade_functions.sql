DROP FUNCTION access_control.fn_get_system_user;
DROP FUNCTION access_control.fn_get_audit_root_key;
DROP FUNCTION access_control.fn_get_effective_access;
DROP FUNCTION access_control.fn_get_effective_grant;
DROP FUNCTION access_control.sp_grant_access;
DROP FUNCTION access_control.sp_revoke_access;
DROP FUNCTION access_control.sp_add_group;
DROP FUNCTION access_control.sp_remove_group;
DROP FUNCTION access_control.sp_add_user;
DROP FUNCTION access_control.sp_remove_user;
DROP FUNCTION access_control.sp_add_user_to_group;
DROP FUNCTION access_control.sp_remove_user_from_group;
DROP FUNCTION access_control.sp_add_remove_user_from_group;
...
DROP FUNCTION audit.fn_add_audit_row;
