...
-- Lock Database
UPDATE public.databasechangeloglock SET LOCKED = TRUE, LOCKEDBY = 'fe80:0:0:0:1c10:e9ff:fe2e:90fb%veth5ab3d08 (fe80:0:0:0:1c10:e9ff:fe2e:90fb%veth5ab3d08)', LOCKGRANTED = '2020-04-30 08:41:58.139' WHERE ID = 1 AND LOCKED = FALSE;
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('0000000000-0', 'frankvr', 'changelog_public.json', NOW(), 1, '7:d5a846da0e565d38de37bd9796a80cdc', 'sqlFile', '', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-4', 'frankvr (generated)', 'changelog_public.json', NOW(), 3, '7:b76022a66fe9a8f91de5fb7d17c47332', 'createTable', '', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-15', 'frankvr (generated)', 'changelog_public.json', NOW(), 12, '7:c55eea72d75664aff4a68c811abc7cad', 'createTable', '', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-48', 'frankvr (generated)', 'changelog_public.json', NOW(), 40, '7:d42346f5b62859d2812dd33494a7e857', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-50', 'frankvr (generated)', 'changelog_public.json', NOW(), 41, '7:b5dbd4b9352778f158f52167304c5c3c', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-51', 'frankvr (generated)', 'changelog_public.json', NOW(), 42, '7:dba55a681b8008a0c065db45de6f7a95', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-52', 'frankvr (generated)', 'changelog_public.json', NOW(), 43, '7:618af9228d9ac663796b9aa515f1901d', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-53', 'frankvr (generated)', 'changelog_public.json', NOW(), 44, '7:dde337c696912fe2726d8a2dc96b1479', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1581943138671-54', 'frankvr (generated)', 'changelog_public.json', NOW(), 45, '7:887e94ecf8749cee679eaa9f23813d1c', 'addForeignKeyConstraint', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('0000000000-1', 'frankvr', 'changelog_public.json', NOW(), 46, '7:6448ed5d210fcedcdc72742cef7224a1', 'sqlFile (x2)', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('c55ef5c4-6b58-41e6-8134-61d1c1ae225b-1', 'frankvr', 'changelog_public.json', NOW(), 47, '7:12768b5b4e2c6451175e7680cf81e246', 'createTable', 'Add support for tags', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('c55ef5c4-6b58-41e6-8134-61d1c1ae225b-2', 'frankvr', 'changelog_public.json', NOW(), 48, '7:67672169b167dc3fcd44d4dbcfc22f83', 'addForeignKeyConstraint', 'Add support for tags', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('c55ef5c4-6b58-41e6-8134-61d1c1ae225b-3', 'frankvr', 'changelog_public.json', NOW(), 49, '7:17477af9273ee76f3f268d0e5486aea1', 'createTable, createIndex', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('0000000000-1000000', 'frankvr', 'changelog_public.json', NOW(), 50, '7:afc99baa9ac1279b46cc0aa22ff31d8d', 'sqlFile', '', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('70772cde-c594-4937-97af-5caf00950a46', 'frankvr', 'changelog_public.json', NOW(), 51, '7:b9e61a1a0d97b27a92577c9d09ff9cee', 'sqlFile', 'Load units', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('c55ef5c4-6b58-41e6-8134-61d1c1ae225b-4', 'frankvr', 'changelog_public.json', NOW(), 52, '7:96e1cb6381dfd1b125088e2dd6a4079a', 'sqlFile', 'Add support for tags', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('c127a622-b465-4ec4-93d8-a34ead141099', 'frankvr', 'changelog_public.json', NOW(), 53, '7:996c3e00e092c577a60d0bb54bab9689', 'sqlFile', 'Add standard views', 'EXECUTED', NULL, NULL, '3.4.1');

INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('4090ac4b-735c-4ea7-adb8-d2082cddc365', 'frankvr', 'changelog_public.json', NOW(), 54, '7:5812af58c87db3dc6199ae49696db95b', 'sqlFile', 'Modtrack', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('1583403835611-14', 'frankvr (generated)', 'changelog_asset.json', NOW(), 7, '7:0e413b233b4c03b29a7b7b1be6511f90', 'createTable', '', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('f8f5de0f-e360-458a-af11-336e59d279f7', 'frankvr', 'changelog_asset.json', NOW(), 46, '7:598b1b1fbc724425a1b894559ce0b48c', 'sqlFile (x2)', '', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('8ed152b2-f8c7-403e-a57e-737ee5f370dc', 'frankvr', 'changelog_dtpw.json', NOW(), 15, '7:7d49681e980088816c29345d00d4b148', 'sqlFile', 'Add support for tags', 'EXECUTED', NULL, NULL, '3.4.1');
...
INSERT INTO public.databasechangelog (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE) VALUES ('668ca1e7-bfb5-4b7e-afad-513cd6516538', 'frankvr', 'changelog_dtpw.json', NOW(), 17, '7:e3be5ee5a39dc944966f07f906992171', 'sqlFile (x3)', 'Apply baked in db users', 'EXECUTED', NULL, NULL, '3.4.1');
